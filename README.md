...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-11 07:31`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e23e7e9c-d266-4496-a4a9-b4d8f7b604fc.git
$ cd e23e7e9c-d266-4496-a4a9-b4d8f7b604fc
```
